using Nepacina_Jaymhar_Angel_Act_GUI;
using System;
...
namespace Nepacina_Jaymhar_Angel_Act_GUI;
...
public partial class EditForm : Form
{
    ...
    private UserProfile GetUserProfile()
    {
        ...
        {
            Name = "Jaymhar Nepacina",
            Age = 21,
            Address = "Buenlag 1st Bayambang Pangasinan",
            ContactNumber = "09304389440",
            Email = "jaymharnepacina@gmail.com",
            Course = "BSIT",
            Year = "Third",
            ParentName = "Margie Nepacina",
            ParentContact = "09993169692",
